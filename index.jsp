			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<!-- /.breadcrumb -->
                                                <div style="padding: 5px; margin-left: 15px;"><b>ACHEIVEMENTS</b></div>
              ...
              <%
              int i=0;
             	String selAch="select * from acheivements where type=1";
             ...
             %>
                ...
                <b><%=rsAch.getString("discription") %></b>     
                								...
                								String lgId=rsAch.getString("loginId");
                									String sel2="select * from staf_data where stfif=(select uid from user_log where id='"+lgId+"')";
                									ResultSet rs2=statement2.executeQuery(sel2);
                									while(rs2.next()){
                										%>
                											<td>
                											 <img src="../photos/<%=rs2.getString("pic") %>" style="border-radius: 50%; height: 100px;"/>
                											<br>
                											Name : <%=rs2.getString("nme") %>
                												<br>
                											Contact : <%=rs2.getString("con") %>
                											</td>
                											<%
