...
if(request.getParameter("sub")!=null){
	 ...
	 String upsem=request.getParameter("upsem");
	 System.out.println("Updated semester "+crs+"  "+dep+" "+ay+"  "+upsem);
	 String upSem="update student_data set sem='"+upsem+"' where crs='"+crs+"' and dep=(select depid from dep_info where dep_nme='"+dep+"' and crsid='"+crs+"') and ay='"+ay+"'";
	 statement.executeUpdate(upSem);
	 response.sendRedirect("upsem.jsp");
	...
	<head>
		...
		//	alert("server ready");
			...
			$("#yid").change(function(){
				...
				var dep=$("#did").val();
				var yid=$("#yid").val();
				//alert("course "+course+" department "+dep+" year = "+yid);
				var sm="";
				$.getJSON("jsonSem.jsp?crs="+course+"&dep="+dep+"&yr="+yid,function(ja){
					for(var i=0;i<ja.length;i++){
						dt=ja[i].ksem;
						//alert(dt);
					}
					$("#csem").append(dt);
					$("#usem").append(parseInt(dt)+1);
					$("#upsem").val(parseInt(dt)+1);
				})
			});
		});
		</script>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <form method="get" action="upsem.jsp">
                                                            ...
                                                            <table class="table table-bordered table-responsive">
                                                                    ...
                                                                    <td style="width: 50%;">
                                                                        <select name="crs" id="crs" class="form-control" onchange="loaddep(this.value)">
                                                                            <option>Choose</option>
                                                                                    ...
                                                                                    <%
                                                                                    String selCr="select * from crs_info";
                                                                                    ResultSet rsselCr=statement.executeQuery(selCr);
                                                                                    while(rsselCr.next()){
                                                                                    %>
                                                                            <option value="<%=rsselCr.getString("crsid")%>"><%=rsselCr.getString("crs_nme")%></option>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <select name="ay" class="form-control" required="required" onchange="loaddata(this.value)" id="yid">
                                                               ...
                                                               %>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="text" name="upsem" id="upsem" /> 
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2"><center>
