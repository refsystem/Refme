                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="col-lg-6">
                                                            ...
                                                            <table class="table table-bordered table-condensed table-responsive table-striped">
                                                                <tr>
                                                                    <td colspan="2"><center><b>ADD FACULTY DETAILS</b></center></td>
                                                                </tr>                                                                
                                                        ...
                                                        <div class="col-lg-6">
                                                                ...
                                                                <%
                                                                	if((request.getParameter("sid")!=null)&&(request.getParameter("delstid")!=null)){
                                                                		System.out.println(request.getParameter("sid")+"   "+request.getParameter("delstid"));
                                                                		String delStfId=request.getParameter("sid");
                                                                		try{
                                                                			String delStaff="delete from staf_data where stfif='"+delStfId+"'";
                                                                			statement.executeUpdate(delStaff);
                                                                	...
                                                                	if(rsStaff.next()){
                                                                		%>
                                                                		 <a href="faculty.jsp"><span class="label label-danger pull-right">BACK</span></a>
                							<table class="table table-bordered table-condensed table-hover table-striped">
                							<tr>
                    							<td style="width: 50%"><center>
                       							 <img src="../photos/<%=rsStaff.getString("pic") %>" class="img img-responsive img-thumbnail" />
                        
                       							 <a href="faculty.jsp?sid=<%=stffId %>&delstid=1" class="label label-danger">Delete Faculty</a>
                                                                        		...
                                                                        		while(rsInfo.next()){
                                                                        			...
                                                                        			%>
                                                                        			 <tr>
                                                                    					...
                                                                    					<td><a href="faculty.jsp?sid=<%=rsInfo.getString("stfif") %>"><span class="fa fa-arrow-circle-right"></span></a></td>
                                                                					</tr>
                                                                        			<%
                                                                        		}
                                                                        		if(i==0){
