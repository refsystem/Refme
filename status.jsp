...
<html lang="en">
	...
	<script type="text/javascript" src="jquery-1.7.1.js"></script>
		...
		$(document).ready(function(){
			...
			//	alert("course "+course);
				var dt="";
				$.getJSON("jsonDept2.jsp?crs="+course,function(ja){
						...
						<div class="row">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="col-lg-8">
                                                          ...
                                                          <form action="statusAction.jsp" method="post" enctype="multipart/form-data">  
                                                        ...
                                                        <tr>
                                                        	<td>Course</td>
                                                        	   <td>
                                                                        <select name="crs" class="form-control" id="cid">
                                                                            <option value="">Choose</option>
                                                                                    ...
                                                                                    while(rs1.next()){
                                                                                    %>
                                                                            <option><%=rs1.getString("crs_nme")%></option>
                                                        ...
                                                        <tr>
                                                        	<td>Department</td>
                                                        	   <td>
                                                                        <div id="dep1">
                                                                            <select name="dpt" class="form-control" id="did">
                                                                            <option value="">Choose</option>
                                                                            </select>
                                                                        </div>
                                                                    </td>
                                                        ...
                                                        <tr>
                                                        	...
                                                        	<td>
                                                        	<textarea rows="" cols="" name="des" class="form-control"></textarea>
                                                        	
                                                        </tr>
                                                        <tr>
                                                        	<td>Photo</td>
                                                        	<td><input type="file" name="f1" class="form-control"></td>
                                                        </tr>
                                                         <tr>
                                                                    <td colspan="2"><center>
                                                                        <input type="submit" name="sub" value="ADD STATUS NOW" class="btn btn-sm btn-success" /> 
                                                                </center></td>
                                                                </tr>
                                                        </table>
                                                       </form>
